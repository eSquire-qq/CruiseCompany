...
<div class="container" style="background-color: #2c656a">
    <div class="card-header my-lg-3" style="text-align: center; color: #fff; font-family: 'Mulish', sans-serif; font-size: 2vmin;"> All Cruises</div>
    <div class="row">
        <%
            if (!cruises.isEmpty()){
        ...
        <div class="col-md-4 my-3" style="padding-bottom: 2rem;">
            <div class="card" style="width: 19rem; height: 25rem; margin: auto" >
                <div class="card-body">
                    ...
                    <h6 class="card-title">Passenger_capacity: <%= cruise.getPassengerCapacity()%> </h6>
                    ...
                    <a href="Payments.jsp" class="btn btn-primary" style="background-color: #448b85; border-color: #448b85;">Buy</a>
                </div>
            </div>
        </div>
        <%
