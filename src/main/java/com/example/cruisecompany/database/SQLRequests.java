...
public class SQLRequests {
    ...
    public static final String CREAT_CRUISE = "INSERT INTO \"cruise\" (duration, price, cruise_start_date, cruise_end_date, cruise_liner_name,passenger_capacity,status, cruise_name)\" +\n" +
            "                                 \" VALUES (?,?,?,?,?,?,?,?)";
